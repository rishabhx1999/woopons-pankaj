...
const mapDispatchToProps = (dispatch) => ({
	onSubmit: (formData) => {
    	dispatch({ type: CREATE_CUSTOMER, payload: agent.common.customercreate(formData) });
  	},
...
const MainView = (props) => {
	...
	const { currentAdminUser,currentUser,onSubmit,successMsg,errorMsg,clearCustomerMessages, customerUser } = props;
								        ...
								        <Row>
								        	...
								        	<Col lg={12} className="mt-4">
								        		<div className="right-profile-btn text-right">
							        				<Button className="orange-btn custom-btn w-100" onClick={submitBtn}>Send OTP</Button>
							        			</div>
								        	</Col>
