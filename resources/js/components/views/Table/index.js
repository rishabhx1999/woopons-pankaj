...
const Table = (props) => {
  const  { Lists, submitAction, setDeleteCoupon, showToggle, setShowToggle } = props
  ...
  // render() {
    ...
    const ShowLinkFormatter = (cell, row) => {
        ...
        return (
          <div className="coupon-actions">
            ...
            <span onClick={()=> deleteAction(cell)} className="bedge-btn red-bedge">Delete</span>
          </div>
        );
    }
    ...
    let popupProps = {
      showToggle,
      handleModalClose,
      modalMessage: 'Are you sure you want to delete your WOO-PON?',
      notesMessage: '(Please Note: this will also delete your deal from the app)',
      submitAction,
    }
